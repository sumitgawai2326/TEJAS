...
base_service = r"C:\Users\Admin\.gemini\antigravity\scratch\krishidrishti-edge\backend\app\services\crop_detection"
...
from ai.inference.manager import get_vision_manager
...
with open(os.path.join(base_service, "vision_service.py"), "w", encoding="utf-8") as f:
    f.write(service_code)

init_code = """from app.services.crop_detection.vision_service import VisionPipelineService, vision_service

__all__ = ["VisionPipelineService", "vision_service"]
"""

with open(os.path.join(base_service, "__init__.py"), "w", encoding="utf-8") as f:
    f.write(init_code)

print("VisionPipelineService created successfully.")

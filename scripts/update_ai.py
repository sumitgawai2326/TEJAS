...
with open(os.path.join(base_ai, "base.py"), "w", encoding="utf-8") as f:
    f.write(ai_code)

# 2. ai/inference/__init__.py
ai_init = """from ai.inference.base import (
    BaseVisionModel,
    DemoVisionModel,
    AcceleratorDetector,
    get_vision_model
...
with open(os.path.join(base_ai, "__init__.py"), "w", encoding="utf-8") as f:
    f.write(ai_init)

print("AI Inference & Confidence Gating Abstraction updated.")
